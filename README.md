...
支持**一年级至三年级**（语文、数学、英语），题型紧贴人教版教材和常见练习册。只需选好年级、题量，点击按钮即可自动生成练习题，并支持在线作答、即时批改、错题纠正与打印输出。
...
├── chinese-types.html      # 语文题型选择
├── english-types.html      # 英语题型选择
...
│   ├── common.js           # App 全局 + PluginUtil（随机/标准化/工厂）
│   ├── common.css          # 全局样式
