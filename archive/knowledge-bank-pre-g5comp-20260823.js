        ...
        },
        {
          ...
          knowledgePoints: [
            ...
            },
            {
              ...
              related: ["g5-m4-g5-fill-fm","g5-c2-c2-prime","g5-m11-g5-judge-fm"],
              difficulty: 1,
              status: "active"
            },
            {
          ...
          knowledgePoints: [
            {
              ...
              related: ["g5-c1-c1-horizontal","g5-c2-c2-place"],
              difficulty: 4,
              status: "active"
            },
            {
              id: "g5-c1-c1-horizontal",
              name: "横式数字谜",
              pluginId: "math-competition-c1-numberpuzzle",
              weight: 2,
              type: "horizontal",
              ...
              related: ["g5-c1-c1-vertical","g5-c1-c1-symbol"],
              difficulty: 4,
              status: "active"
            },
            {
              ...
              related: ["g5-c2-c2-place","g5-c1-c1-horizontal"],
              difficulty: 4,
              status: "active"
            },
            {
              ...
              example: "在三阶数阵中填1-9，使每行每列和都为15。",
              prerequisites: ["g4-c1-c1-array"],
              related: ["g5-c1-c1-magic","g5-c1-c1-symbol"],
              difficulty: 4,
              status: "active"
            },
            {
              ...
              description: "理解幻方的规律并填数。",
              example: "完成中间为5的三阶幻方。",
              prerequisites: ["g5-c1-c1-array"],
              related: ["g5-c1-c1-array"],
              difficulty: 4,
              status: "active"
            }
          ]
          ...
          knowledgePoints: [
            {
              ...
              related: ["g5-c2-c2-divisible","g5-c2-c2-remainder"],
              difficulty: 4,
              status: "active"
            },
            {
              id: "g5-c2-c2-divisible",
              name: "整除特征（2/3/5/9）",
              pluginId: "math-competition-c2-numbertheory",
              weight: 3,
              type: "divisible",
              ...
              related: ["g5-c2-c2-factor","g5-c2-c2-prime"],
              difficulty: 4,
              status: "active"
            },
            {
              ...
              related: ["g5-c2-c2-factor","g5-c2-c2-divisible"],
              difficulty: 4,
              status: "active"
            },
            {
              ...
              related: ["g5-c2-c2-prime","g5-c2-c2-divisible"],
              difficulty: 4,
              status: "active"
            },
            {
              id: "g5-c2-c2-remainder",
              name: "余数问题",
              pluginId: "math-competition-c2-numbertheory",
              weight: 2,
              type: "remainder",
              ...
              related: ["g5-c2-c2-divisible","g5-c2-c2-factor"],
              difficulty: 4,
              status: "active"
            },
            {
              ...
              related: ["g5-c1-c1-symbol","g5-m4-g5-fill-decloc"],
              difficulty: 4,
              status: "active"
            }
          ]
          ...
          knowledgePoints: [
            {
              ...
              example: "用1、2、3能组成几个无重复数字的两位数？（答案：6个）",
              prerequisites: ["g4-c3-c3-enum"],
              related: ["g5-c3-c3-am","g5-c3-c3-worst"],
              difficulty: 4,
              status: "active"
            },
            {
              ...
              example: "上衣3件、裤子2件，共有几种穿法？（答案：6种）",
              prerequisites: ["g4-c3-c3-am"],
              related: ["g5-c3-c3-perm","g5-c3-c3-enum"],
              difficulty: 4,
              status: "active"
            },
            {
              ...
              description: "初步认识排列与组合的区别。",
              example: "从3人中选2人排成一排有几种？（答案：6种）",
              prerequisites: ["g5-c3-c3-am"],
              related: ["g5-c3-c3-am","g5-c3-c3-worst"],
              difficulty: 4,
              status: "active"
            },
            {
              id: "g5-c3-c3-geomcount",
              name: "几何计数",
              pluginId: "math-competition-c3-counting",
              weight: 2,
              type: "geomcount",
              ...
              related: ["g5-c4-c4-count","g5-c3-c3-enum"],
              difficulty: 4,
              status: "active"
            },
            {
              ...
              description: "考虑最坏情况，保证结论必然成立。",
              example: "两色球各若干，至少拿几个保证同色？（答案：3个）",
              prerequisites: ["g5-c3-c3-enum"],
              related: ["g5-c3-c3-enum","g5-m10-g5-reason-tree3"],
              difficulty: 4,
              status: "active"
            }
          ]
          ...
          knowledgePoints: [
            {
              ...
              example: "速度4米/秒，走10秒，路程？（答案：40米）",
              prerequisites: ["g4-c5-c5-basic"],
              related: ["g5-c5-c5-meet","g5-c5-c5-chase","g5-m8-g5-word-decmul"],
              difficulty: 4,
              status: "active"
            },
            {
              ...
              description: "两人相向而行，路程和=速度和×时间。",
              example: "相距100米，两人速度和10，几秒相遇？（答案：10秒）",
              prerequisites: ["g5-c5-c5-basic"],
              related: ["g5-c5-c5-chase","g5-c5-c5-train"],
              difficulty: 4,
              status: "active"
            },
            {
              ...
              example: "甲速6、乙速4，相差20米，几秒追上？（答案：10秒）",
              prerequisites: ["g5-c5-c5-basic"],
              related: ["g5-c5-c5-meet","g5-c5-c5-train"],
              difficulty: 4,
              status: "active"
            },
            {
              ...
              example: "车长100米过200米桥，完全通过要走？（答案：300米）",
              prerequisites: ["g5-c5-c5-basic"],
              related: ["g5-c5-c5-meet","g5-c5-c5-river"],
              difficulty: 4,
              status: "active"
            },
            {
          ...
          knowledgePoints: [
            {
              ...
              example: "边长为4的正方形，周长和面积各是？（答案：周长16，面积16）",
              prerequisites: ["g4-c4-c4-pa"],
              related: ["g5-c4-c4-cutfill","g5-m4-g5-fill-area"],
              difficulty: 4,
              status: "active"
            },
            {
              ...
              description: "用割补法把不规则图形转化为规则图形求面积。",
              example: "把不规则图形割补成长方形求面积。",
              prerequisites: ["g5-c4-c4-pa"],
              related: ["g5-c4-c4-pa","g5-m4-g5-fill-area"],
              difficulty: 4,
              status: "active"
            },
            {
              ...
              related: ["g5-c4-c4-pa","g5-c4-c4-count"],
              difficulty: 4,
              status: "active"
            },
            {
              ...
              related: ["g5-c3-c3-geomcount","g5-c4-c4-angle"],
              difficulty: 4,
              status: "active"
            },
            {
              id: "g5-c4-c4-transform",
              name: "平移旋转与对称",
              pluginId: "math-competition-c4-geometry",
              weight: 2,
              type: "transform",
              ...
              related: ["g5-m6-g5-draw-rotate","g5-m6-g5-draw-sym"],
              difficulty: 4,
              status: "active"
            },
            {
          ...
          knowledgePoints: [
            {
              ...
              prerequisites: ["g5-m8-g5-word-decdiv"],
              related: ["g5-c6-c6-concentration","g6-m8-g6-app-travel-work","g5-c5-c5-basic"],
              difficulty: 4,
              status: "active"
            },
            {
              id: "g5-c6-c6-concentration",
              name: "浓度问题",
              pluginId: "math-competition-c6-engineering",
              weight: 3,
              type: "concentration",
              ...
              prerequisites: ["g5-m8-g5-word-decdiv"],
              related: ["g5-c6-c6-work","g5-c7-c7-clever","g5-m8-g5-word-frac"],
              difficulty: 4,
              status: "active"
            }
          ]
          ...
          knowledgePoints: [
            {
              ...
              related: ["g5-c7-c7-complex","g5-c7-c7-clever"],
              difficulty: 4,
              status: "active"
            },
            {
              ...
              prerequisites: ["g5-m3-g5-mix-fracmixed"],
              related: ["g5-c7-c7-telescope","g5-c7-c7-clever"],
              difficulty: 4,
              status: "active"
            },
            {
              ...
              prerequisites: ["g5-m3-g5-mix-fracsimple"],
              related: ["g5-c7-c7-telescope","g5-c7-c7-complex"],
              difficulty: 4,
              status: "active"
            },
            {
              ...
              related: ["g5-c7-c7-telescope","g5-m10-g5-reason-seq"],
              difficulty: 4,
              status: "active"
            }
          ]
        ...
        },
        {
          ...
          knowledgePoints: [
            ...
            },
            {
              ...
              related: ["g4-c5-c5-meet","g5-c6-c6-work","g6-m8-g6-app-frac-div"],
              difficulty: 1,
              status: "active"
            },
            {
          ...
          knowledgePoints: [
            {
              ...
              description: "根据竖式中已知的部分数字，推理填出完整的竖式。",
              example: "□5+3□=82，求出两个□中的数字。",
              prerequisites: ["g5-c1-c1-vertical"],
            ...
            },
            {
              ...
              description: "在横式中填入合适的数字，使等式成立。",
              example: "□+□=9，且两个□中的数字不同。",
              prerequisites: ["g5-c1-c1-horizontal"],
        ...
        },
        {
          ...
          knowledgePoints: [
            ...
            },
            {
              ...
              description: "掌握能被2、3、5、9整除的数的特征。",
              example: "下列各数中能被3整除的是？（答案：123）",
              prerequisites: ["g5-c2-c2-divisible"],
            ...
            },
            {
              ...
              description: "解决带余除法的应用问题。",
              example: "□÷5=3……2，□=?（答案：17）",
              prerequisites: ["g5-c2-c2-remainder"],
        ...
        },
        {
          ...
          knowledgePoints: [
            ...
            },
            {
              ...
              description: "数出图形中的线段、角、三角形个数。",
              example: "一条线段上有4个点，共有几条线段？（答案：10条）",
              prerequisites: ["g5-c3-c3-geomcount"],
        ...
        },
        {
          ...
          knowledgePoints: [
            ...
            },
            {
              ...
              description: "认识图形的对称、平移与旋转。",
              example: "判断下列图形是否轴对称。",
              prerequisites: ["g5-c4-c4-transform"],
        ...
        },
        {
          ...
          knowledgePoints: [
            ...
            },
            {
              ...
              description: "含盐率=盐重÷盐水总重，混合与稀释均按此计算。",
              example: "100克10%盐水加100克水，含盐率？（答案：5%）",
              prerequisites: ["g5-c6-c6-concentration"],
          ...
          knowledgePoints: [
            {
              ...
              description: "把每一项拆成两个分数之差，相加时首尾相消。",
              example: "1/(1×2)+1/(2×3)+…+1/(9×10)=?（答案：9/10）",
              prerequisites: ["g5-c7-c7-telescope"],
            ...
            },
            {
              ...
              description: "多层分式从最里层逐层通分，除以分数等于乘它的倒数。",
              example: "1÷(2+1/3)=?（答案：3/7）",
              prerequisites: ["g5-c7-c7-complex"],
            ...
            },
            {
              ...
              description: "由前几项归纳通项公式，再求指定项。",
              example: "1/2、2/3、3/4、4/5…第10项是?（答案：10/11）",
              prerequisites: ["g5-c7-c7-pattern"],
