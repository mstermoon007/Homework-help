    ...
    // ========== 年级6 ==========
    {
      ...
      modules: [
        ...
        },
        {
          ...
          knowledgePoints: [
            ...
            },
            {
              ...
              related: ["g6-m8-g6-app-pigeonhole","g6-c3-worst-case-principle"],
              difficulty: 1,
              status: "active"
            }
          ]
        ...
        },
        {
          ...
          knowledgePoints: [
            {
              id: "g6-c1-digit-puzzle-vertical",
              name: "竖式谜（乘除法深化）",
              pluginId: "math-competition-placeholder",
              weight: 1,
              type: "vertical",
              description: "乘除法竖式中填缺失数字，进退位更复杂，需位值分列推理。",
              example: "三位数 × 一位数竖式中补全 □ 使竖式成立。",
              prerequisites: ["g5-c1-digit-puzzle-vertical"],
              related: ["g6-c1-digit-puzzle-horizontal"],
              difficulty: 3,
              status: "placeholder"
            },
            {
              id: "g6-c1-digit-puzzle-horizontal",
              name: "横式谜（括号与运算符号）",
              pluginId: "math-competition-placeholder",
              weight: 1,
              type: "horizontal",
              description: "填运算符号与括号使等式成立，需要枚举与估算结合。",
              example: "在 5 5 5 5 之间填符号（可加括号）使结果等于 10。",
              prerequisites: ["g5-c1-digit-puzzle-horizontal"],
              related: ["g6-c1-digit-puzzle-symbol"],
              difficulty: 3,
              status: "placeholder"
            },
            {
              id: "g6-c1-digit-puzzle-symbol",
              name: "字母符号代表数（多位数）",
              pluginId: "math-competition-placeholder",
              weight: 1,
              type: "symbol",
              description: "多位数字母算式（如 ABC×D），利用进位链与首位不为零推理。",
              example: "ABC×A＝DDA 型字母竖式求各字母。",
              prerequisites: ["g5-c1-digit-puzzle-symbol"],
              related: ["g6-c1-digit-puzzle-vertical"],
              difficulty: 4,
              status: "placeholder"
            },
            {
              id: "g6-c1-number-array-closed",
              name: "封闭型数阵（复杂图形）",
              pluginId: "math-competition-placeholder",
              weight: 1,
              type: "array-closed",
              description: "多边形数阵边和相等，重叠格重复次数增多，用总和配平。",
              example: "把 1~8 填入四边形数阵使每边三数和相等。",
              prerequisites: ["g5-c1-number-array-closed"],
              related: ["g6-c1-number-array-radial"],
              difficulty: 4,
              status: "placeholder"
            },
            {
              id: "g6-c1-number-array-radial",
              name: "辐射型数阵（重复数策略）",
              pluginId: "math-competition-placeholder",
              weight: 1,
              type: "array-radial",
              description: "辐射数阵中心数多次重复，先定中心再分配外围。",
              example: "中心数重复 4 次的辐射数阵每线和相等。",
              prerequisites: ["g5-c1-number-array-radial"],
              related: ["g6-c1-number-array-composite"],
              difficulty: 4,
              status: "placeholder"
            },
            {
              id: "g6-c1-number-array-composite",
              name: "复合型数阵",
              pluginId: "math-competition-placeholder",
              weight: 1,
              type: "array-composite",
              description: "封闭与辐射叠加的复合数阵，多约束联立求解。",
              example: "复合数阵中同时满足边和与线和相等。",
              prerequisites: ["g5-c1-number-array-composite"],
              related: ["g6-c1-number-array-closed"],
              difficulty: 5,
              status: "placeholder"
            },
            {
              id: "g6-c1-magic-square-3",
              name: "三阶幻方（性质与应用）",
              pluginId: "math-competition-placeholder",
              weight: 1,
              type: "magic3",
              description: "巩固洛书结构：幻和 15、中心 5、对角互补等性质的灵活应用。",
              example: "已知三阶幻方部分格子，利用性质快速补全。",
              prerequisites: ["g5-c1-magic-square-3"],
              related: ["g6-c1-magic-square-4"],
              difficulty: 3,
              status: "placeholder"
            },
            {
              id: "g6-c1-magic-square-4",
              name: "四阶幻方（补全与性质）",
              pluginId: "math-competition-placeholder",
              weight: 1,
              type: "magic4",
              description: "四阶幻方幻和 34 与对称交换构造，补全含缺格的幻方。",
              example: "四阶幻方中由行列性质确定缺格数字。",
              prerequisites: ["g5-c1-magic-square-4"],
              related: ["g6-c1-magic-square-3"],
              difficulty: 4,
              status: "placeholder"
            }
          ]
        },
        {
          ...
          knowledgePoints: [
            ...
            },
            {
              ...
              prerequisites: ["g5-c2-remainder-congruence"],
              related: ["g6-c2-modulo-arithmetic"],
              difficulty: 5,
              status: "placeholder"
            },
            ...
            },
            {
              ...
              prerequisites: ["g5-c2-perfect-square"],
              related: ["g6-c2-prime-factorization"],
              difficulty: 4,
              status: "placeholder"
            },
            ...
            },
            {
              ...
              prerequisites: ["g5-c9-diophantine-equation"],
              related: ["g6-c2-remainder-congruence"],
              difficulty: 5,
              status: "placeholder"
            },
            {
              id: "g6-c2-modulo-arithmetic",
              name: "模运算与周期（大指数）",
              pluginId: "math-competition-placeholder",
              weight: 1,
              type: "modulo",
        ...
        },
        {
          ...
          knowledgePoints: [
            ...
            },
            {
              ...
              prerequisites: ["g5-c3-enumeration-counting"],
              related: ["g6-c3-enumeration-counting"],
              difficulty: 5,
              status: "placeholder"
            },
            {
              id: "g6-c3-derangement",
              name: "错排问题（初步）",
              pluginId: "math-competition-placeholder",
              weight: 1,
              type: "derangement",
        ...
        },
        {
          ...
          knowledgePoints: [
            ...
            },
            {
              ...
              prerequisites: ["g5-c4-circle-sector"],
              related: ["g6-c4-circle-angle"],
              difficulty: 4,
              status: "placeholder"
            },
            {
              id: "g6-c4-solid-geometry",
              name: "立体图形（表面积、体积、切割）",
              pluginId: "math-competition-placeholder",
              weight: 1,
              type: "solid",
              ...
              prerequisites: ["g5-c4-solid-geometry"],
              related: ["g6-c4-solid-rotation"],
              difficulty: 4,
              status: "placeholder"
            },
            {
        ...
        },
        {
          ...
          knowledgePoints: [
            ...
            },
            {
              ...
              prerequisites: ["g5-c5-meet-problem"],
              related: ["g6-c5-pick-up-problem"],
              difficulty: 5,
              status: "placeholder"
            },
            {
              id: "g6-c5-pick-up-problem",
              name: "接送问题（往返接送）",
              pluginId: "math-competition-placeholder",
              weight: 1,
              type: "pick-up",
        ...
        },
        {
          ...
          knowledgePoints: [
            ...
            },
            {
              ...
              example: "双堆取石子的必胜策略。",
              prerequisites: ["g5-c8-winning-strategy"],
              related: ["g6-c8-optimization"],
              difficulty: 5,
              status: "placeholder"
            },
            {
              id: "g6-c8-optimization",
              name: "统筹优化（烙饼、排队、过桥）",
              pluginId: "math-competition-placeholder",
              weight: 1,
              type: "optimization",
              ...
              prerequisites: ["g5-c8-extremum-problem"],
              related: ["g6-c8-extremum-problem"],
              difficulty: 4,
              status: "placeholder"
            }
          ]
        },
        {
          ...
          knowledgePoints: [
            ...
            },
            {
              ...
              prerequisites: ["g5-c9-grass-problem"],
            ...
            },
            {
              ...
              related: ["g6-c9-diophantine-equation"],
              difficulty: 3,
              status: "placeholder"
            },
            {
              ...
              prerequisites: ["g5-c5-ratio-motion"],
              related: ["g6-c9-mixture-problem"],
              difficulty: 5,
              status: "placeholder"
            },
            {
              id: "g6-c9-mixture-problem",
              name: "混合问题（平均价、合金）",
              pluginId: "math-competition-placeholder",
              weight: 1,
              type: "mixture",
