...
(function(global) {
  var PLUGIN_REGISTRY = [
    ...
    { id: 'math-clock', file: 'plugins/math-clock.js', name: '认识钟表', subject: 'math', category: 'number', grades: [1, 2], moduleIds: ['M4'] },
    { id: 'math-patterns', file: 'plugins/math-patterns.js', name: '找规律', subject: 'math', category: 'number', grades: [1, 2], moduleIds: ['M4'] },
    ...
    { id: 'math-g1-operation', file: 'plugins/math-g1-operation.js', name: '操作题', subject: 'math', category: 'geometry', grades: [1, 2], moduleIds: ['M6', 'M9'] },
    ...
    // 数学（二年级·任务二新增题型插件）
    { id: 'math-g2-judge', file: 'plugins/math-g2-judge.js', name: '判断题', subject: 'math', category: 'mixed', grades: [2], moduleIds: ['M11'] },
    { id: 'math-g2-choice', file: 'plugins/math-g2-choice.js', name: '选择题', subject: 'math', category: 'mixed', grades: [2], moduleIds: ['M12'] },
    { id: 'math-g2-matching', file: 'plugins/math-g2-matching.js', name: '连线题', subject: 'math', category: 'mixed', grades: [2], moduleIds: ['M5'] },
    { id: 'math-g2-column', file: 'plugins/math-g2-column.js', name: '竖式计算', subject: 'math', category: 'number', grades: [2], moduleIds: ['M2'] },
    { id: 'math-g2-mixed', file: 'plugins/math-g2-mixed.js', name: '脱式计算', subject: 'math', category: 'number', grades: [2], moduleIds: ['M3'] },
    { id: 'math-g2-picture-equations', file: 'plugins/math-g2-picture-equations.js', name: '看图列式', subject: 'math', category: 'number', grades: [2], moduleIds: ['M7'] },
    // 数学（三年级）
  ...
  { id: 'math-match', runtimeId: 'math-match', file: 'plugins/math-match.js', name: '连线题', subject: 'math', category: 'mixed', grades: [4, 5, 6], moduleIds: ['M5'] },
