  ...
  var plugin = {
    ...
    render(exerciseSet) {
      ...
      exerciseSet.questions.forEach((q, idx) => {
        html += `<div class="question-card comp-card" data-index="${idx}" style="border:1px solid var(--line);border-radius:14px;padding:14px 0.5cm;background:#fff;position:relative;text-align:center;box-shadow:0 8px 24px rgba(40,70,120,.08);">`;
