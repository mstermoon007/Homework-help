 ...
 *
 * 依据《技术文档--基础》§5 难度锚点标定（R2 重构锚点表）与用户确认的 Q6 锚点表。
 * 2026 P16 canonical 派生 seedDifficulty 重锚（derived 为唯一真值，锚点由派生结果反推）：
 *   G1 2-5 / G2 3-6 / G3 4-9 / G4 5-9 / G5 6-10 / G6 7-10
 * 语义：该年级 KP 的基础难度应落在锚点区间 [min,max]；区间随年级螺旋上升（非递减）。
 *
