// shared/svg/svg-calculation.js — 竖式计算图形生成器（SVGCalculation）
//
// 依赖 shared/svg/svg-core.js。输出完整 <svg> 字符串，可直接赋给题目 q.svg。
//
// API：
...
(function (global) {
  ...
  if (!U) throw new Error('shared/svg/svg-calculation.js 依赖 shared/svg/svg-core.js，请先加载');
