// shared/svg/svg-make-ten.js — 凑十 / 平十 / 破十 图解生成器（SVGMakeTen）
//
// 依赖 shared/svg/svg-core.js。输出完整 <svg> 字符串（可直接赋给 q.svg），
...
(function (global) {
  ...
  if (!U) throw new Error('shared/svg/svg-make-ten.js 依赖 shared/svg/svg-core.js，请先加载');
