// @ts-check
/** 
 * shared/catalog/difficulty.js — 统一难度解析模块（挂载 window.App.Difficulty）
 *
 ...
 *
 * 依赖：shared/core/common.js（复用 diffLevel/diffScale/diffMax；浏览器先加载 common.js，
...
(function (global) {
  ...
  if (!_PU || !_PU.diffLevel) throw new Error('shared/catalog/difficulty.js 依赖 shared/core/common.js（PluginUtil.diffLevel）');
