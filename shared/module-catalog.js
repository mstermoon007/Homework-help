 ...
 *
 * 数据结构：
 *   MODULE_CATALOG[] -> { id, name, grades: number[], category, level }
...
(function(global) {
  const BASIC_MODULES = [
    ...
    { id: 'M5', name: '连线题', grades: [1,2,3,4,5], category: 'mixed', level: 'basic' },
    { id: 'M6', name: '操作题', grades: [1,2,3,4,5,6], category: 'geometry', level: 'basic' },
    { id: 'M7', name: '看图列式', grades: [1,2,3,4,5], category: 'number', level: 'basic' },
  ...
  const COMPETITION_MODULES = [
    { id: 'C1', name: '数字谜与数阵图', grades: [4,5,6], category: 'number', level: 'competition' },
    { id: 'C2', name: '数论初步', grades: [4,5,6], category: 'number', level: 'competition' },
    { id: 'C3', name: '组合计数', grades: [4,5,6], category: 'number', level: 'competition' },
    { id: 'C4', name: '几何模型', grades: [4,5,6], category: 'geometry', level: 'competition' },
    { id: 'C5', name: '行程问题', grades: [4,5,6], category: 'number', level: 'competition' },
    { id: 'C6', name: '工程与浓度', grades: [5,6], category: 'number', level: 'competition' },
    { id: 'C7', name: '分数与巧算', grades: [5,6], category: 'number', level: 'competition' },
    { id: 'C8', name: '最值与逻辑推理', grades: [4,5,6], category: 'statistics', level: 'competition' },
    { id: 'C9', name: '竞赛综合', grades: [4,5,6], category: 'mixed', level: 'competition' }
  ];
