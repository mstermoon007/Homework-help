          ...
          knowledgePoints: [
            {
              ...
              common_errors: [{"id":"split-error","category":"calculation","description":"加数拆分错误，凑不成 10"},{"id":"remnant-omission","category":"calculation","description":"凑成 10 后遗漏加剩余部分"}],
              graphicType: "diagram",
              prerequisites: [],
            ...
            },
            {
              ...
              common_errors: [{"id":"split-error","category":"calculation","description":"减数拆分未先取个位，凑不成整十"},{"id":"borrow-omission","category":"calculation","description":"连续减时漏减剩余部分"}],
              graphicType: "diagram",
            ...
            },
            {
              ...
              common_errors: [{"id":"split-error","category":"calculation","description":"被减数拆分错误"},{"id":"remnant-omission","category":"calculation","description":"10 减减数后遗漏加剩余部分"}],
              graphicType: "diagram",
              prerequisites: ["math-g1-m0-make-ten"],
            ...
            },
            {
              ...
              common_errors: [{"id":"step-sequence-error","category":"reasoning","description":"对凑十/破十步骤顺序或拆分过程判断错误"}],
              graphicType: "diagram",
              prerequisites: ["math-g1-m0-make-ten"],
          ...
          knowledgePoints: [
            {
              ...
              common_errors: [{"id":"count-error","category":"calculation","description":"点数/口算计数错误"},{"id":"sign-confusion","category":"notation","description":"加号减号混淆"}],
              graphicType: "diagram",
            ...
            },
            {
              ...
              common_errors: [{"id":"count-error","category":"calculation","description":"口算计数错误"},{"id":"compose-decompose-error","category":"concept","description":"分与合不熟练导致计算错误"},{"id":"sign-confusion","category":"notation","description":"加号减号混淆"}],
              graphicType: "diagram",
            ...
            },
            {
              ...
              common_errors: [{"id":"split-error","category":"calculation","description":"凑十拆分错误"},{"id":"remnant-omission","category":"calculation","description":"凑十后漏加剩余数"}],
              graphicType: "diagram",
            ...
            },
            {
              ...
              common_errors: [{"id":"borrow-omission","category":"calculation","description":"退位减法忘记退位"},{"id":"split-error","category":"calculation","description":"破十/平十拆分错误"}],
              graphicType: "diagram",
            ...
            },
            {
              ...
              common_errors: [{"id":"count-error","category":"calculation","description":"十位计算错误"},{"id":"place-value-error","category":"concept","description":"整十数相加减时个位处理错误"}],
            ...
            },
            {
              ...
              common_errors: [{"id":"digit-confusion","category":"concept","description":"个位与十位混淆、错位相加减"},{"id":"carry-omission","category":"calculation","description":"进位加法忘记进位"}],
              graphicType: "number-line",
            ...
            },
            {
              ...
              common_errors: [{"id":"order-error","category":"structure","description":"未按从左到右顺序计算"},{"id":"count-error","category":"calculation","description":"中间步骤计算错误"}],
              graphicType: "diagram",
          ...
          knowledgePoints: [
            {
              ...
              common_errors: [{"id":"place-value-error","category":"concept","description":"十位/个位表示的数混淆"},{"id":"compose-decompose-error","category":"concept","description":"数的组成拆分错误"}],
              graphicType: "diagram",
              prerequisites: [],
            ...
            },
            {
              ...
              common_errors: [{"id":"place-value-error","category":"concept","description":"数位意义混淆"},{"id":"notation-error","category":"notation","description":"读数或写数错误"}],
              graphicType: "diagram",
            ...
            },
            {
              ...
              common_errors: [{"id":"adjacent-confusion","category":"concept","description":"相邻数取错（只找一个/把自身算入）"}],
              graphicType: "number-line",
              prerequisites: ["math-g1-m4-compose-number"],
            ...
            },
            {
              ...
              common_errors: [{"id":"comparison-direction-error","category":"concept","description":"大于号/小于号方向写反"},{"id":"comparison-digit-error","category":"concept","description":"比较时看错位数或数位"}],
              graphicType: "number-line",
              prerequisites: ["math-g1-m4-compose-number","math-g1-m4-digit-place"],
            ...
            },
            {
              ...
              common_errors: [{"id":"compose-decompose-error","category":"concept","description":"分与合结果写错或漏写"},{"id":"pair-omission","category":"attention","description":"分与合遗漏部分组合"}],
              graphicType: "diagram",
              prerequisites: ["math-g1-m4-compose-number"],
            ...
            },
            {
              ...
              common_errors: [{"id":"pattern-rule-error","category":"reasoning","description":"规律判断错误"},{"id":"pattern-extension-error","category":"reasoning","description":"按规律续写数错误"}],
              graphicType: "number-line",
              prerequisites: ["math-g1-m4-compose-number"],
            ...
            },
            {
              ...
              common_errors: [{"id":"clock-hand-confusion","category":"concept","description":"时针分针混淆"},{"id":"clock-read-error","category":"reading","description":"读钟面时间错误"}],
              graphicType: "diagram",
              prerequisites: ["math-g1-m4-compose-number"],
            ...
            },
            {
              ...
              common_errors: [{"id":"clock-approx-confusion","category":"concept","description":"快几时/刚过几时判断颠倒"}],
              graphicType: "diagram",
            ...
            },
            {
              ...
              common_errors: [{"id":"unit-confusion","category":"unit","description":"元角分单位混淆"},{"id":"unit-convert-error","category":"unit","description":"单位换算进率错误"}],
              graphicType: "diagram",
              prerequisites: ["math-g1-m4-compose-number"],
            ...
            },
            {
              ...
              common_errors: [{"id":"unit-confusion","category":"unit","description":"单位未统一直接加减"},{"id":"unit-convert-error","category":"unit","description":"角/分与元换算错误"}],
              graphicType: "diagram",
            ...
            },
            {
              ...
              common_errors: [{"id":"chart-position-error","category":"concept","description":"百数表中数的位置判断错误"},{"id":"place-value-error","category":"concept","description":"上下/左右相邻数关系错误"}],
              graphicType: "grid",
              prerequisites: ["math-g1-m4-compose-number","math-g1-m4-digit-place"],
            ...
            },
            {
              ...
              common_errors: [{"id":"inverse-operation-error","category":"reasoning","description":"求未知数选错运算"},{"id":"count-error","category":"calculation","description":"计算错误"}],
              graphicType: "number-line",
              prerequisites: ["math-g1-m1-addsub-10","math-g1-m4-compose-number"],
          ...
          knowledgePoints: [
            {
              ...
              common_errors: [{"id":"shape-name-confusion","category":"concept","description":"立体图形名称/特征混淆"},{"id":"solid-flat-confusion","category":"concept","description":"立体图形与平面图形混淆"}],
            ...
            },
            {
              ...
              common_errors: [{"id":"shape-name-confusion","category":"concept","description":"平面图形名称/特征混淆"},{"id":"flat-edge-confusion","category":"concept","description":"长方形与正方形边特征混淆"}],
              graphicType: "geometry",
            ...
            },
            {
              ...
              common_errors: [{"id":"count-omission","category":"attention","description":"图形计数遗漏或重复"},{"id":"shape-name-confusion","category":"concept","description":"图形类型识别错误"}],
              graphicType: "geometry",
            ...
            },
            {
              ...
              common_errors: [{"id":"left-right-confusion","category":"concept","description":"左右方位混淆"},{"id":"position-reference-error","category":"concept","description":"相对位置的参照对象搞错"}],
              graphicType: "diagram",
              prerequisites: [],
            ...
            },
            {
              ...
              common_errors: [{"id":"shape-combine-error","category":"reasoning","description":"拼组关系判断错误"}],
              graphicType: "geometry",
              prerequisites: ["math-g1-m6-flat-shape"],
            ...
            },
            {
              ...
              common_errors: [{"id":"shape-draw-error","category":"writing","description":"画图不规范（边不直、特征不符）"}],
              graphicType: "geometry",
              prerequisites: ["math-g1-m6-flat-shape"],
          ...
          knowledgePoints: [
            {
              ...
              common_errors: [{"id":"picture-read-error","category":"reading","description":"看图信息读取错误（数量看错）"},{"id":"model-error","category":"reasoning","description":"合起来误用减法"}],
              graphicType: "diagram",
              prerequisites: ["math-g1-m1-addsub-10"],
            ...
            },
            {
              ...
              common_errors: [{"id":"picture-read-error","category":"reading","description":"看图信息读取错误"},{"id":"model-error","category":"reasoning","description":"去掉/拿走误用加法"}],
              graphicType: "diagram",
              prerequisites: ["math-g1-m1-addsub-10"],
            ...
            },
            {
              ...
              common_errors: [{"id":"picture-read-error","category":"reading","description":"多步图信息读取错误"},{"id":"order-error","category":"structure","description":"连加连减顺序错误"}],
              graphicType: "diagram",
            ...
            },
            {
              ...
              common_errors: [{"id":"brace-direction-error","category":"reading","description":"求总数/求部分判断错误"},{"id":"model-error","category":"reasoning","description":"列式方向错误"}],
              graphicType: "diagram",
          ...
          knowledgePoints: [
            {
              ...
              common_errors: [{"id":"word-model-error","category":"reasoning","description":"数量关系判断错误"},{"id":"word-read-error","category":"reading","description":"应用题信息提取错误"}],
              graphicType: "diagram",
              prerequisites: ["math-g1-m1-addsub-10"],
            ...
            },
            {
              ...
              common_errors: [{"id":"remain-part-confusion","category":"reasoning","description":"求剩余与求部分建模混淆"},{"id":"word-read-error","category":"reading","description":"应用题信息提取错误"}],
              graphicType: "diagram",
            ...
            },
            {
              ...
              common_errors: [{"id":"more-less-direction-error","category":"reasoning","description":"比多比少运算方向错误"},{"id":"word-read-error","category":"reading","description":"\"比…多几\"信息提取错误"}],
              graphicType: "diagram",
            ...
            },
            {
              ...
              common_errors: [{"id":"more-less-direction-error","category":"reasoning","description":"比多比少运算方向错误"},{"id":"word-read-error","category":"reading","description":"\"比…少几\"信息提取错误"}],
              graphicType: "diagram",
              prerequisites: ["math-g1-m4-compare-number","math-g1-m8-sub-remain"],
            ...
            },
            {
              ...
              common_errors: [{"id":"two-step-order-error","category":"structure","description":"两步计算的中间量求错"},{"id":"word-model-error","category":"reasoning","description":"数量关系建模错误"}],
              graphicType: "diagram",
            ...
            },
            {
              ...
              common_errors: [{"id":"unit-confusion","category":"unit","description":"元角分单位未统一"},{"id":"word-model-error","category":"reasoning","description":"总价/找零数量关系错误"}],
              graphicType: "diagram",
            ...
            },
            {
              ...
              common_errors: [{"id":"extra-condition-error","category":"reading","description":"被多余条件误导"},{"id":"word-model-error","category":"reasoning","description":"有用条件筛选错误"}],
              graphicType: "diagram",
          ...
          knowledgePoints: [
            {
              ...
              common_errors: [{"id":"classify-standard-error","category":"concept","description":"分类标准不一致或混乱"},{"id":"classify-omission","category":"attention","description":"分类遗漏项目"}],
              graphicType: "chart",
              prerequisites: [],
            ...
            },
            {
              ...
              common_errors: [{"id":"stats-count-error","category":"attention","description":"统计计数错误"},{"id":"stats-read-error","category":"reading","description":"读统计表信息错误"}],
              graphicType: "chart",
            ...
            },
            {
              ...
              common_errors: [{"id":"picto-scale-error","category":"reading","description":"象形图单位（一图代表几）换算错误"},{"id":"stats-count-error","category":"attention","description":"读图计数错误"}],
              graphicType: "chart",
          ...
          knowledgePoints: [
            {
              ...
              common_errors: [{"id":"multiplication-fact-confusion","category":"operation","description":"乘法口诀混淆"},{"id":"multiply-add-confusion","category":"concept","description":"乘法与加法意义混淆"}],
              graphicType: "grid",
              prerequisites: [],
            ...
            },
            {
              ...
              common_errors: [{"id":"division-fact-confusion","category":"operation","description":"除法求商口诀混淆"},{"id":"divide-multiply-confusion","category":"concept","description":"除法与乘法关系混淆"}],
              graphicType: "grid",
            ...
            },
            {
              ...
              common_errors: [{"id":"multiplication-fact-confusion","category":"operation","description":"用口诀求未知数错误"}],
              graphicType: "grid",
              prerequisites: ["math-g1-m13-multiplication-table"],
          ...
          knowledgePoints: [
            {
              ...
              common_errors: [{"id":"matching-link-error","category":"attention","description":"连错算式与得数"}],
              graphicType: "diagram",
              prerequisites: ["math-g1-m1-addsub-10"],
            ...
            },
            {
              ...
              common_errors: [{"id":"shape-name-confusion","category":"concept","description":"图形与名称对应错误"}],
              graphicType: "geometry",
            ...
            },
            {
              ...
              common_errors: [{"id":"clock-read-error","category":"reading","description":"读钟面时间错误"}],
              graphicType: "diagram",
              prerequisites: ["math-g1-m4-clock-read"],
              related: ["math-g1-m4-clock-read"],
              difficulty: 1,
            ...
            },
            {
              ...
              operations: ["identify","classify"],
              factualContent: {"unit":["元","角","分"],"relationship":"1 元=10 角，1 角=10 分"},
              common_errors: [{"id":"unit-confusion","category":"unit","description":"人民币面值单位混淆"}],
              graphicType: "diagram",
          ...
          knowledgePoints: [
            {
              ...
              common_errors: [{"id":"concept-confusion","category":"concept","description":"概念辨析错误"},{"id":"step-sequence-error","category":"reasoning","description":"计算/推理过程判断错误"}],
              graphicType: "custom",
          ...
          knowledgePoints: [
            {
              ...
              factualContent: {"range":"覆盖一年级全册知识：数与运算、图形、时间、人民币、分类统计"},
              common_errors: [{"id":"distractor-confusion","category":"concept","description":"受干扰项误导选错"},{"id":"concept-confusion","category":"concept","description":"概念辨析错误"}],
              graphicType: "custom",
