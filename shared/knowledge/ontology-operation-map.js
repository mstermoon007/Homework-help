/**
 * shared/knowledge/ontology-operation-map.js — Curated Plugin → Canonical Operations (M1-02.1)
 *
...
(function (global) {
  ...
  // ---- 操作 ID → 符号/计算方法/视觉别名 的唯一翻译字典 ----
  // GENERATOR/PRESENTATION 拿到 operationIds 后必须经此查询，禁止硬编码。
  var OP_SEMANTICS = {
